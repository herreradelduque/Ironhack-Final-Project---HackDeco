...
def features_extraction_user(feat_extractor):
    ...
    #np.save('./data/features_extraction_user/img_features_user',img_features_user)
    return img_features_user
    #print("img_features_user saved at: './data/img_features_user/img_features_user.npy'")
