...
def cos_simil(shop,product,img_features_user):
    ...
    if shop in shop_list:
        ...
        # 5. compute cosine similarities
            ...
            img_features_user #= np.load('./data/features_extraction_user/img_features_user.npy')
        ...
        # Save as csv:
            #cos_similarities_merged_df.to_csv(f'../data/cos_similarities_{shop.lower()}_{product}.csv', index=False)
            # Save json:
